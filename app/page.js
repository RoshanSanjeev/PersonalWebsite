      ...
      <div className="min-h-screen text-foreground flex flex-col items-center pt-24 pb-10 relative" style={{ backgroundColor, '--text-primary': textColor, '--text-secondary': secondaryTextColor }}>
        ...
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100vw-2rem)] 2xl:w-auto max-w-[95rem] rounded-full animate-fadeInUp">
          ...
          >
            ...
            <div className="2xl:hidden grid grid-cols-[1fr_auto_1fr] w-full items-center px-5 py-1">
              {/* Left: Social Icons */}
        ...
        <div className="relative z-10 flex flex-col items-center w-full px-4 pt-10">
          ...
          {/* HOME / HERO SECTION */}
          <section id="Home" className="w-full max-w-[95rem] mb-12 relative min-h-[80vh] flex flex-col justify-center">
          ...
          {/* EXPERIENCE SECTION */}
          <section id="Experience" className="w-full max-w-7xl px-4 py-20 scroll-mt-24">
            <ScrollReveal>
