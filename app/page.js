      ...
      <div className="min-h-screen text-foreground flex flex-col items-center pt-24 pb-10 relative" style={{ backgroundColor, '--text-primary': textColor, '--text-secondary': secondaryTextColor }}>
        ...
        <div className="relative z-10 flex flex-col items-center w-full px-4">
          ...
          <div className="w-full max-w-[95rem] mb-16 animate-fadeInUp relative">
            {/* Social Icons - Top Left of Hero */}
            <div className="absolute -top-20 left-0 z-50 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
            ...
            {/* Color Theme Selector - Top Right of Hero */}
            <div className="absolute -top-20 right-0 z-50 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
              <ColorThemeSelector />
            </div>
