        ...
        <div className="relative z-10 flex flex-col items-center px-4 pt-32">
          ...
          <div className="w-full max-w-5xl mb-12 animate-fadeInUp">
            <div className="flex flex-col lg:flex-row gap-6 items-start">
              ...
              <div className="relative group rounded-3xl flex-1 order-2 lg:order-1">
                <span
              ...
              {/* Profile Picture */}
              <div className="relative group flex-shrink-0 animate-fadeInUp order-1 lg:order-2" style={{ animationDelay: '0.4s' }}>
                <div
            ...
            {sections.map((section) => (
              <div key={section} className="relative group rounded-full">
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-full text-base font-medium transition-all duration-300 backdrop-blur-sm relative bg-white/10 border border-white/20 ${activeSection === section
