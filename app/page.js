      ...
      <div className="min-h-screen text-foreground flex flex-col items-center pt-24 pb-10 relative" style={{ backgroundColor, '--text-primary': textColor, '--text-secondary': secondaryTextColor }}>
        ...
        <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50 max-w-[calc(100vw-3rem)] rounded-full animate-fadeInUp">
          ...
          >
            ...
            <div className="2xl:hidden flex items-center pl-2">
              <button
                onClick={() => setIsMenuOpen(!isMenuOpen)}
                className="p-2 -ml-2 rounded-full hover:bg-white/10 transition-colors text-[var(--text-secondary)] hover:text-[var(--text-primary)]"
        ...
        {/* Fixed Color Theme Selector - Top Right parallel to nav */}
        <div className="fixed top-6 right-6 z-50 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
          <ColorThemeSelector />
        </div>

        {/* Fixed Social Icons - Top Left parallel to nav */}
        <div className="fixed top-6 left-6 z-50 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
